...
export class ProjectJP extends Model<InferAttributes<ProjectJP, { omit: "id" }>, InferCreationAttributes<ProjectJP, { omit: "id" }>> implements IProject {
  declare id: string
...
export const ProjectSetting_JP = setModel({
  model: ProjectJP,
  attributes: {
    title: {
